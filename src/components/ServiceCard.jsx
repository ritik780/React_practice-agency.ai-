...
const ServiceCard = ({ service, index }) => {
  ...
  return (
    ...
    <div
      ...
      />
      <div className='flex items-center gap-10 p-8 hover:p-7 hover:m-0.5  hover:cursor-pointer transition-all rounded-[10px] bg-white dark:bg-gray-900 z-10 relative'>
